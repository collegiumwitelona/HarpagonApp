    ...
    <div className="h-screen flex flex-col bg-slate-50 font-sans text-slate-900 overflow-hidden">
      ...
      <main className="grow flex flex-col justify-center items-center px-6 bg-hero-blur w-full text-center space-y-12">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white!">
          Zarządzaj swoim budżetem <br />
          <span className="text-violet-700">lepiej niż kiedykolwiek</span>
        </h1>
        
        <p className="text-lg md:text-xl text-white! leading-relaxed max-w-2xl pt-10">
          Dzięki naszej platformie możesz łatwo śledzić swoje wydatki, planować budżet i osiągać swoje cele finansowe.
        </p>
