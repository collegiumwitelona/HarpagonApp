  ...
  return (
    <div className="h-screen flex flex-col bg-slate-50 font-sans text-slate-900 overflow-hidden">
      ...
      <main className="grow flex flex-col justify-center items-center px-6 bg-hero-blur w-full relative">
        ...
        <div className="relative z-10 max-w-md w-full bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-slate-100">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="flex flex-col gap-2 text-left">
              ...
              <input 
                ...
                className="w-full px-5 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:bg-white transition-all shadow-sm"
              />
            </div>
            ...
            >
            <Link to="/dashboard" className="px-5 py-2.5 font-medium">
            Zaloguj się
            </Link>
            </button>
          </form>
